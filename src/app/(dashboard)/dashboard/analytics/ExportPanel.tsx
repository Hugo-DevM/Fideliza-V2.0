      ...
      <div className="flex items-start justify-between gap-3">
        ...
        {!isPro && (
          <a href="/dashboard/settings"
            className="shrink-0 inline-flex items-center gap-1.5 rounded-xl border border-gray-200 dark:border-[#1e2438] px-3 py-1.5 text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="rounded-xl border border-gray-200 dark:border-[#1e2438] bg-white dark:bg-[#1a1f35] px-3 py-2 text-sm text-gray-800 dark:text-gray-200 focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400"
              />
            </div>
            <div className="flex flex-col gap-1">
