    ...
    <div className="min-h-screen bg-gray-950 text-gray-100">
        ...
        <Container className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1 rounded-md bg-white/5 border border-white/10 p-0.5">
              <a href={`/es/privacy`} className={`px-2.5 py-1 rounded text-xs font-medium transition-colors ${isEs ? 'bg-indigo-500 text-white' : 'text-gray-400 hover:text-white'}`}>ES</a>
              <a href={`/en/privacy`} className={`px-2.5 py-1 rounded text-xs font-medium transition-colors ${!isEs ? 'bg-indigo-500 text-white' : 'text-gray-400 hover:text-white'}`}>EN</a>
            </div>
      ...
      <Container className="py-10 max-w-3xl">
        ...
        <div className="pt-10 pb-4 text-center text-xs text-gray-600 border-t border-white/5 mt-10">
          ...
          <a href={`/${lang}/terms`} className="hover:text-gray-400 transition-colors">
