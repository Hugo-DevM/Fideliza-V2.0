...
export async function middleware(request: NextRequest) {
  ...
  // Redirect authenticated users away from login/register — but not from /auth/callback
  // or /auth/register/confirm (those are part of the signup flow and need to be accessible)
