    ...
    <div className="relative mx-auto w-full max-w-sm select-none">
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-4">
          <div>
            <div className="text-xs text-indigo-300 font-medium mb-0.5 uppercase tracking-wide">
              Brew &amp; Bean Coffee
            </div>
        ...
        <div className="px-5 pb-5">
          <div className="flex items-center justify-between text-xs text-indigo-400">
            ...
            <span className="font-mono tracking-widest bg-white/8 rounded px-2 py-0.5 text-indigo-200">
              ALIC-BB01
            </span>
          </div>
        </div>
          ...
          <div className="text-center lg:text-left">
            ...
            >
              ...
              <LinkButton
                ...
                size="lg"
                variant="ghost"
                className="text-gray-300 hover:text-white hover:bg-white/10 whitespace-nowrap"
              >
                {t.cta2}
              </LinkButton>
            </motion.div>
              ...
              <div className="flex -space-x-2">
                {["B", "M", "S", "K"].map((letter, i) => (
                  <div
                    ...
                    style={{
                      background: ["#4f46e5", "#7c3aed", "#0891b2", "#059669"][
                        i
                      ],
                    }}
                  >
