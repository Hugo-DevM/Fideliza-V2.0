export const en = {
    ...
    visuals: {
      ...
      transaction: {
        rows: [
          ...
          { label: 'Redeemed: Free Coffee', points: '−250', type: 'redeem' as const },
        ],
  ...
  benefits: {
    ...
    dashboard: {
      ...
      activity: [
        ...
        { name: 'Dan Kowalski', action: 'Redeemed Free Slice',  time: '18m ago' },
  ...
  pricing: {
    ...
    plans: [
      {
        ...
        price: '$0',
        period: 'forever',
        description: 'Try Fideliza+ risk-free. Good for validating with your first customers.',
        badge: null,
        highlight: false,
        features: [
          'Up to 50 customers',
      ...
      },
      {
        ...
        price: '$19',
        period: '/month',
        description: 'For growing businesses ready to turn regulars into loyal customers.',
        badge: 'Most popular',
        highlight: true,
        features: [
          'Up to 500 customers',
      ...
      },
      {
        ...
        price: '$49',
        period: '/month',
        description: 'For established businesses with a serious loyalty strategy.',
        badge: null,
        highlight: false,
        features: [
          'Unlimited customers',
    ...
    footnote: 'Pricing shown is pre-launch. Early access members lock in founder rates.',
  },

  cta: {
    badge: 'Early access open',
    heading: 'Launch your loyalty program this week',
    body: 'Join the waitlist and be among the first businesses to run Fideliza+. Early access members lock in founder pricing — 3 months of Starter, free.',
    bullets: [
  ...
  footer: {
    tagline: 'Loyalty programs for independent businesses. No app downloads. No complexity. Just customers coming back.',
    product: 'Product',
    legal: 'Legal',
    nav: {
      product: [
    ...
    bottomTagline: 'Built for independent businesses that deserve better tools.',
  },
