...
export const es: Dictionary = {
  meta: {
    ...
    ogTitle: 'Fideliza+ — Programas de Fidelización para Negocios Independientes',
    ogDescription:
    ...
    visuals: {
      ...
      transaction: {
        rows: [
          ...
          { label: 'Canje: Café Gratis',  points: '−250', type: 'redeem' as const },
        ],
        balanceLabel: 'Saldo',
      },
    },
  ...
  benefits: {
    ...
    dashboard: {
      ...
      activity: [
        ...
        { name: 'Dan Kowalski', action: 'Canjeó Rebanada Gratis', time: 'hace 18m' },
  ...
  pricing: {
    ...
    body: 'Comienza gratis y mejora solo cuando lo necesites. Los usuarios de acceso anticipado obtienen 3 meses de Starter gratis.',
    plans: [
      {
        name: 'Gratis',
        price: '$0',
        period: 'siempre',
        description: 'Prueba Fideliza+ sin riesgo. Ideal para validar con tus primeros clientes.',
        badge: null,
        highlight: false,
        features: [
          'Hasta 50 clientes',
      ...
      },
      {
        ...
        price: '$19',
        period: '/mes',
        description: 'Para negocios en crecimiento listos para convertir habituales en clientes leales.',
        badge: 'Más popular',
        highlight: true,
        features: [
          'Hasta 500 clientes',
      ...
      },
      {
        ...
        price: '$49',
        period: '/mes',
        description: 'Para negocios consolidados con una estrategia de fidelización seria.',
        badge: null,
        highlight: false,
        features: [
          'Clientes ilimitados',
    ...
    footnote: 'Precios previos al lanzamiento. Los miembros de acceso anticipado bloquean tarifas de fundadores.',
  },
  ...
  footer: {
    tagline: 'Programas de fidelización para negocios independientes. Sin descargas. Sin complejidad. Solo clientes que regresan.',
    product: 'Producto',
    legal: 'Legal',
    nav: {
      product: [
    ...
    bottomTagline: 'Hecho para negocios independientes que merecen mejores herramientas.',
  },
